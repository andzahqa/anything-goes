# Progress Tracker - BI Learning Journey
...
- [ ] Phase 4: Business Intelligence & Advanced (Weeks 12-15)
...
- [ ] Lookup functions (VLOOKUP, INDEX/MATCH): ___/5
- [ ] Pivot tables: ___/5
- [ ] Charts and visualization: ___/5
- [ ] Power Query (Excel): ___/5
- [ ] Power Pivot & DAX (Excel): ___/5
- [ ] Google Sheets QUERY(): ___/5
- [ ] Apps Script basics: ___/5
- [ ] Dashboard design: ___/5

### Data Analysis Skills
- [ ] Data cleaning: ___/5
- [ ] Statistical thinking: ___/5
- [ ] SQL queries: ___/5
- [ ] Python basics: ___/5
- [ ] Pandas data manipulation: ___/5
- [ ] Data visualization: ___/5
- [ ] Data modeling: ___/5

### BI & Visualization
- [ ] Chart selection: ___/5
- [ ] Dashboard design principles: ___/5
- [ ] Interactivity: ___/5
